                ...
                <div
                    ...
                    <div class="p-5">
                        ...
                        <div class="flex items-center justify-between mt-4">
                            ...
                            <a
                                href="details.html?id=${p.id}&title=${p.title}"
                                class="bg-blue-500 hover:bg-blue-600 text-white text-sm font-semibold px-4 py-2 rounded-lg transition duration-200 cursor-pointer">
                                Details
                            </a>
                            <button
                                class="bg-orange-500 hover:bg-orange-600 text-white text-sm font-semibold px-4 py-2 rounded-lg transition duration-200 cursor-pointer">
                                Add to Cart
                            </button>
                        </div>
                    </div>
